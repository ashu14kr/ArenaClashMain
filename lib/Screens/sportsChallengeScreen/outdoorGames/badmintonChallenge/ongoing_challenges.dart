                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          const Text('Winning',
                                              style: TextStyle(
                                                  color: Colors.grey)),
                                          Text(whoAccepted.winningCoins.toString()+'.00 coins',
                                              style: const TextStyle(
                                                  color: Colors.white))
                                        ],
                                      ),
                                      ...
                                      child: Row(
                                        ...
                                        children:[
                                          const Text('Contact Details',
                                              style: TextStyle(
                                                  color: Colors.grey)),
                                          Text(whoAccepted.userWhoCreatedContactDetail.toString(),
                                              style: const TextStyle(
                                                  color: Colors.white))
                                        ],
                                      ),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    children: [
                                     Text("BADMINTON_"+whoAccepted.matchType.toString(),
                                          style: const TextStyle(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Text(whoAccepted.winningCoins.toString()+".00",
                                            style:
