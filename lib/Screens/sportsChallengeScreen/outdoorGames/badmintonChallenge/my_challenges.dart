...
class BadmintonMyChallenges extends StatefulWidget {
  const BadmintonMyChallenges({Key? key}) : super(key: key);

  @override
  _BadmintonMyChallengesState createState() => _BadmintonMyChallengesState();
}
...
class _BadmintonMyChallengesState extends State<BadmintonMyChallenges> {
  ...
  void initState() {
    _loading = true;
    Provider.of<GetFinishedContest>(context, listen: false)
        .getFinishedContest()
        .then((value) => {
          setState((){
            _data = value;
        ...
        body: SizedBox(
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                BadmintonContestByAccepted data = _data![index];
                return Padding(
                  padding:
