...
class BadmintonWinOrLoss extends StatefulWidget {
  const BadmintonWinOrLoss({ Key? key }) : super(key: key);

  @override
  _BadmintonWinOrLossState createState() => _BadmintonWinOrLossState();
}

class _BadmintonWinOrLossState extends State<BadmintonWinOrLoss> {
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  InkWell(
                                    onTap: (){
                                      Provider.of<BadmintonHelper>(context, listen: false).fullChallengeDetail(context);
                                    },
