            ...
            body: SizedBox(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return distance <= 2000 && badmintonContestData.userUidWhoCreated != FirebaseAuth.instance.currentUser!.uid
                        ? Padding(
                                                            ...
                                                            InkWell(
                                                              onTap: () async {
                                                                ...
                                                                if (currentBalance
                                                                  ...
                                                                  try {
                                                                    response = await dio
                                                                        .patch("http://34.93.18.143/walletBalance/user/updated/$currentId", data: {
                                                                          "amount":
                                                                              updateUserBalance,
                                                                        })
                                                                        .whenComplete(() async => {
